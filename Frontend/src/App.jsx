  ...
  return (
   ...
   {/* <BrowserRouter> */}
   {
    <ThemeContext.Provider value = {{mode,setMode}}>
          <nav className={`flex justify-between p-4 w-full ${!mode?"bg-linear-to-r from-blue-600/10 to-purple-600/10 shadow":"bg-linear-to-br from-gray-900 to-gray-800"} `}>
        ...
        <div className="flex justify-between gap-4 text-purple-400 text-mono">
          <Link to={"/"} className="shadow p-2 rounded hover:bg-gray-800 font-serif "> Home</Link>
          ...
          <button className="shadow p-2 rounded hover:bg-gray-800 font-serif " onClick={()=>setMode(!mode)}>{mode?<span className="bg-gray-400 text-white text-xl px-3 py-2 rounded  hover:bg-gray-400 " >☾</span>:<span className="">🔆</span>}</button>
        </div>
      </nav>
   <Routes>
